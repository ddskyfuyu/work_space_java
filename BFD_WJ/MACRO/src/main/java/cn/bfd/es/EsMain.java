...
public class EsMain extends Configured implements Tool{
	...
	public static void main(String[] args) throws Exception {
		...
		int result = ToolRunner.run(new EsMain(), args);
		System.exit(result);
	}
	...
	public int run(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(configuration, "UpdateIndex");


        job.setJarByClass(EsMain.class);
