 ...
 */
public class GetUserInternetAttributeTmp {

    private static Logger LOG = Logger.getLogger(GetUserInternetAttributeTmp.class);
...
//        key_list.add(attr_name);
        ...
        for(int i = 0; i < internetFts.getTerminalBrandsCount(); ++i){
            ...
            int weight = terminal_brand.getWeight();
            //judge whether the key_list contains the second element
//            if(key_list.size() < 4){
//                key_list.add(value);
//            }
