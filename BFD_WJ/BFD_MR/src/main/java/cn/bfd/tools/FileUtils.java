...
public class FileUtils {
    ...
    public static void FillMap(Map<String, Integer> map, int colNum, String fin, String sep,FileSystem fs){
        try{
            String line = null;
            InputStream in = fs.open(new Path(fin));
            BufferedReader br = new BufferedReader(new InputStreamReader(in));
     ...
     * @param fin 读取的文件名
     */
    public static void FillList(List<String> list, String fin){
        try{
            String line = null;
            BufferedReader br = new BufferedReader(new FileReader(new File(fin)));
            while((line = br.readLine()) != null){
